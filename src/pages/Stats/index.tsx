            ...
            <AutoColumn gap="md">
              ...
              <RowBetween>
                <TYPE.white fontSize={14}>
                  Pawthereum is a decentralized community-run charity cryptocurrency that aims to help animal shelters all over the world and has already donated over $380k!
                </TYPE.white>
              </RowBetween>
            </AutoColumn>
          </CardSection>
