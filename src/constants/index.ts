...
export const PAWTH_ADDRESS = '0xaecc217a749c2405b5ebc9857a16d58bdc1c367f'

export const PAWTH: { [chainId in ChainId]: Token } = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, PAWTH_ADDRESS, 9, 'PAWTH', 'Pawthereum'),
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, '0x6d87eb812cabf49e3ae7788aa46559184d0a0d14', 9, 'PAWTH', 'Pawthereum'),
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, PAWTH_ADDRESS, 9, 'PAWTH', 'Pawthereum'),
  [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, PAWTH_ADDRESS, 9, 'PAWTH', 'Pawthereum'),
  [ChainId.KOVAN]: new Token(ChainId.KOVAN, PAWTH_ADDRESS, 9, 'PAWTH', 'Pawthereum'),
}
